...
// Host-owned in the rokctapp shell. tender_sdk installs this service only
// under the control persona (app_type.control), which never fires for the
// rokctapp marker, and rokctapp does not compose tender. The next
// SDK-owned-copy sweep must not remove this file while
// components/custom/hero.tsx imports it.
