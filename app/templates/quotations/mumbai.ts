export const MumbaiQuotation = `
<div class="quotation-box theme-mumbai" style="max-width: 800px; margin: auto; padding: 30px; border: 1px solid #d4edda; background-color: #f8fff9; font-size: 16px; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; color: #155724;">
    <table style="width: 100%; margin-bottom: 30px;">
        <tr>
            ...
            <td style="text-align: right;">
                <h2 style="color: #28a745; margin: 0;">QUOTATION</h2>
