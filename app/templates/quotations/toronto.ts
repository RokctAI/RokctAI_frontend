export const TorontoQuotation = `
<div class="quotation-box theme-toronto" style="max-width: 800px; margin: auto; padding: 30px; border: none; border-top: 10px solid #007bff; box-shadow: 0 0 10px rgba(0, 0, 0, .15); font-size: 16px; line-height: 24px; font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; color: #555;">
    <table cellpadding="0" cellspacing="0" style="width: 100%; line-height: inherit; text-align: left;">
                ...
                <table style="width: 100%;">
                    <tr>
                        <td class="title" style="padding-bottom: 20px;">
                            <h2 style="color: #007bff; margin: 0;">QUOTATION</h2>
        ...
        <tr class="heading">
            ...
            <td style="background: #007bff; color: white; padding: 10px; text-align: right;">Rate</td>
            <td style="background: #007bff; color: white; padding: 10px; text-align: right;">Qty</td>
            <td style="background: #007bff; color: white; padding: 10px; text-align: right;">Amount</td>
        </tr>
