...
export default function AdjustmentsPage() {
  ...
  const [type, setType] = useState<"Credit Adjustment" | "Debit Adjustment">(
    "Credit Adjustment",
  );
        ...
        <div className="p-6 border-b border-gray-100 flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm">
              Manual GL Correction for Loan #{loan.name}
            </p>
          </div>
        </div>
        ...
        <div className="p-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="p-4 bg-gray-50 rounded-xl border border-gray-100 text-sm text-gray-600">
              {type === "Credit Adjustment" ? (
                <p>
                  Reduces the balance (like a payment or waiver). <br />
                  Outstanding:{" "}
                  <strong>
                ...
                <p>
                  Increases the balance (like a charge or reversal). <br />
                  Outstanding:{" "}
                  <strong>
                    {new Intl.NumberFormat("en-ZA", {
                      style: "currency",
