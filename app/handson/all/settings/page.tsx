    ...
    <div className="space-y-8 p-8 max-w-4xl mx-auto">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage your company identity and logos.
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Manage your company logo and print assets.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Used for light backgrounds (Invoices, Normal View)
                      </FormDescription>
                      <FormMessage />
                      {field.value && (
                        <img
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Used for dark headers (Tokyo POS, Rio Invoice)
                      </FormDescription>
                      <FormMessage />
                      {field.value && (
