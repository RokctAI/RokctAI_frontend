...
export default function SettingsPage() {
      ...
      if (synapticData) {
        tenderForm.reset({
          main_procurement_category:
            synapticData.main_procurement_category || "",
        });
      }
  ...
  const onTenderSubmit = async (
    values: z.infer<typeof tenderSettingsSchema>,
  ) => {
    try {
  ...
  const onRegulatorySubmit = async (
    values: z.infer<typeof regulatorySettingsSchema>,
  ) => {
    try {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Configure global tenant behavior.
          </p>
        </div>
      </div>
        ...
        <TabsContent value="email" className="mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure custom SMTP for outgoing emails.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Form {...emailForm}>
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div className="space-y-0.5">
                          ...
                          <CardDescription>
                            Use your own SMTP server instead of the system
                            default.
                          </CardDescription>
                        </div>
                        <FormControl>
        ...
        <TabsContent value="tenders" className="mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure which tenders are fetched for your tenant.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Form {...tenderForm}>
                <form
                  onSubmit={tenderForm.handleSubmit(onTenderSubmit)}
                  className="space-y-6"
                >
                  <FormField
        ...
        <TabsContent value="regulatory" className="mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage company licenses and tax details (Self-Declared).
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Form {...regulatoryForm}>
                <form
                  onSubmit={regulatoryForm.handleSubmit(onRegulatorySubmit)}
                  className="space-y-6"
                >
                  <FormField
                    control={regulatoryForm.control}
                    name="credit_provider_license"
                    render={({ field }) => (
                      <FormItem>
        ...
        <TabsContent value="terms" className="mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage standard terms and conditions for your documents.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <TermsSettings />
