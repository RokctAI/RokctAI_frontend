    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Manage legal text for your documents.
          </p>
        </div>
          ...
          <TableBody>
            {loading ? (
              ...
              <TableRow>
                ...
                >
                  No terms found. Import standard terms to get started.
                </TableCell>
              </TableRow>
            ) : (
              terms.map((t) => (
      ...
      <Dialog open={isEditOpen} onOpenChange={setIsEditOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>
              {editingTerm.name ? "Edit Terms" : "New Terms"}
            </DialogTitle>
          </DialogHeader>
      ...
      <Dialog open={isImportOpen} onOpenChange={setIsImportOpen}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Select standard terms to add to your settings. These will become
              independent copies you can customize.
            </DialogDescription>
          </DialogHeader>
            ...
            <div className="grid gap-3 p-1">
              {masterTerms.map((mt) => (
                ...
                >
                  ...
                  <Button size="sm" onClick={() => handleImport(mt.name)}>
                    Import
                  </Button>
                </div>
              ))}
