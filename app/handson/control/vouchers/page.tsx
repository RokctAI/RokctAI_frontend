            ...
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="text-right">
                  {t("app.control.vouchers.col_actions")}
                </TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
                        ...
                        <div className="flex items-center gap-1.5 text-green-600 dark:text-green-400">
                          ...
                          <span>
                            {v.discount_type === "Percentage"
                              ...
                              : v.discount_amount}{" "}
                            {t("app.control.vouchers.benefit_off")}
                            {v.discount_duration_months > 0 &&
                              t("app.control.vouchers.benefit_recurring", {
                                months: v.discount_duration_months,
                              })}
                          </span>
                        </div>
                      )}
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>
              {editingVoucher
                ? t("app.control.vouchers.dialog_edit")
                : t("app.control.vouchers.dialog_new")}
            </DialogTitle>
            <DialogDescription>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>
                      {t("app.control.vouchers.label_code")}
                    </FormLabel>
                    <FormControl>
              ...
              <div className="grid grid-cols-2 gap-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("app.control.vouchers.label_type")}
                      </FormLabel>
                      <Select
                      ...
                      >
                        <FormControl>
                          <SelectTrigger>
                            <SelectValue
                              placeholder={t("app.control.vouchers.ph_type")}
                            />
                          </SelectTrigger>
                        </FormControl>
                        <SelectContent>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col justify-end space-y-2">
                      <FormLabel>
                        {t("app.control.vouchers.label_active")}
                      </FormLabel>
                      <FormControl>
                        <div className="flex items-center gap-2 h-10">
                          ...
                          <span className="text-sm text-muted-foreground">
                            {field.value
                              ? t("app.control.vouchers.status_enabled")
                              : t("app.control.vouchers.status_disabled")}
                          </span>
                        </div>
                      </FormControl>
                    </FormItem>
                ...
                <div className="space-y-4 bg-green-50 dark:bg-green-900/10 p-4 rounded-lg border border-green-100 dark:border-green-900/30">
                  ...
                  <p className="text-[10px] text-green-600/70 dark:text-green-400/50 mt-1">
                    ...
                    !form.getValues("discount_duration_months")
                      ...
                      : discountScope === "Recurring"
                        ? t("app.control.vouchers.recurring_duration_note", {
                            months: form.getValues("discount_duration_months"),
                          })
              ...
              <div className="grid grid-cols-2 gap-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("app.control.vouchers.label_max_uses")}
                      </FormLabel>
                      <FormControl>
                        <div className="relative">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>
                        {t("app.control.vouchers.label_expiry")}
                      </FormLabel>
                      <FormControl>
            ...
            <DialogFooter className="pt-4">
              ...
              >
                {editingVoucher
                  ? t("common.update")
                  : t("app.control.vouchers.btn_create_voucher")}
              </Button>
            </DialogFooter>
          </Form>
        </DialogContent>
