      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage wallets, ledgers, and payouts.
          </p>
        </div>
        <Button
          variant="outline"
        ...
        <TabsContent value="wallets" className="space-y-4 mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Wallets associated with customers.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                      ...
                      <TableRow key={item.name}>
                        ...
                        <TableCell className="text-right">
                          <Button
                            ...
                            onClick={() => handleDeleteWallet(item.name)}
                          >
                      ...
                      <TableRow key={item.name}>
                        ...
                        <TableCell className="text-right">
                          <Button
                            ...
                            size="icon"
                            className="text-red-500 hover:text-red-600"
                            onClick={() => handleDeleteLedger(item.name)}
                          >
                            <Trash2 className="h-4 w-4" />
                          </Button>
                        </TableCell>
        ...
        <TabsContent value="payouts" className="space-y-4 mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Requests for payouts from tenants.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                      ...
                      <TableRow key={item.name}>
                        ...
                        <TableCell className="text-right">
                          <Button
                            ...
                            size="icon"
                            className="text-red-500 hover:text-red-600"
                            onClick={() => handleDeletePayout(item.name)}
                          >
                            <Trash2 className="h-4 w-4" />
                          </Button>
                        </TableCell>
