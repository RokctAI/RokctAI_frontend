    ...
    <div className="p-6 space-y-6">
          ...
          >
            <CardHeader className="pb-2">
              <div className="flex justify-between items-start">
                ...
                <Badge
                  className={rep.is_active ? "bg-green-600" : "bg-gray-400"}
                >
      ...
      <Dialog open={isEditOpen} onOpenChange={setIsEditOpen}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>
              {editingReport.name ? "Edit Report" : "Create New Report"}
            </DialogTitle>
            <DialogDescription>
              Queries run on the Tenant Site locally. Use standard SQL
              (MariaDB).
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="grid gap-6 py-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(val) =>
                    setEditingReport({ ...editingReport, category: val })
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                onChange={(e) =>
                  setEditingReport({ ...editingReport, sql: e.target.value })
                }
                placeholder="SELECT ... FROM `tabSales Invoice` ..."
              />
              <p className="text-xs text-muted-foreground">
                Access Frappe tables using backticks: `tabDocType`. Do not use
            ...
            <div className="space-y-3 border p-4 rounded-lg bg-muted/20">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="space-y-2">
                  ...
                  <Select
                    value={editingReport.chart_type}
                    onValueChange={(val: any) =>
                      setEditingReport({ ...editingReport, chart_type: val })
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="Explain what this report shows..."
              />
            </div>

            <div className="flex items-center gap-2">
              <Switch
                checked={editingReport.is_active}
                onCheckedChange={(c) =>
                  setEditingReport({ ...editingReport, is_active: c })
                }
              />
