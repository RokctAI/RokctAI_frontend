...
export default function MasterTermsPage() {
  ...
  const [editingTerm, setEditingTerm] = useState<Partial<MasterTerm> | null>(
    null,
  );
    ...
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Define standard legal text blocks (e.g. Payment Terms, Warranty) for
            all tenants.
          </p>
        </div>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            <DialogTitle>
              {editingTerm?.name ? "Edit Term" : "New Master Term"}
            </DialogTitle>
            <DialogDescription>
