    ...
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Define logic that is forced upon all tenants securely.
          </p>
        </div>
      ...
      <Dialog open={isEditOpen} onOpenChange={setIsEditOpen}>
        <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>
              {editingRule.name ? "Edit Rule" : "Create Workflow Rule"}
            </DialogTitle>
            <DialogDescription>
              Rules run automatically when a tenant saves a document.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="grid gap-6 py-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="e.g. Prevent large invoices without tax ID"
              />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2 items-center">
              ...
              <span className="text-sm text-muted-foreground">
                Set to <b>2</b> to skip this rule for Solo Founders (1 user).
                Set <b>0</b> for everyone.
              </span>
            </div>
          </div>
          ...
          <div className="space-y-3 border p-4 rounded-lg bg-muted/20">
            ...
            {editingRule.conditions.map((c, i) => (
              <div key={i} className="flex gap-2 items-center">
                <Input
                  className="w-[150px]"
                  placeholder="Field (e.g. grand_total)"
                  value={c.field}
            ...
            {editingRule.actions.map((a, i) => (
              ...
              >
                ...
                {a.type === "set_field" && (
                  <div className="flex gap-2">
                    <Input
                      placeholder="Field to Set (e.g. status)"
                      value={a.field}
                ...
                {a.type === "block_save" && (
                  <Input
                    placeholder="Error Message to User"
                    value={a.message}
