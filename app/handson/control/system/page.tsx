      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Configure system-wide parameters and authorizations.
          </p>
        </div>
        <Button
          variant="outline"
                  ...
                  {auths.length === 0 ? (
                    ...
                    auths.map((item) => (
                      <TableRow key={item.name}>
                        ...
                        <TableCell>
                          {item.creation
                            ? format(new Date(item.creation), "MMM d, yyyy")
                            : "-"}
                        </TableCell>
        ...
        <TabsContent value="global" className="space-y-4 mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure system-wide platform behavior.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="flex items-center justify-between p-4 border rounded-lg bg-secondary/50">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Displays the "Beta" badge next to the platform name
                    site-wide.
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between p-4 border rounded-lg bg-secondary/50">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Enables showing detailed error messages in public components
                    (like Pricing). This setting is saved to your browser only.
                  </p>
                </div>
                <div className="flex items-center gap-2">
                  {saving && <Loader2 className="h-4 w-4 animate-spin" />}
                  ...
                  <CardContent className="text-sm space-y-2">
                    <div className="flex justify-between">
                      ...
                      <span className="font-mono">
                        {globalSettings?.adminApiKey
                          ? "****" + globalSettings.adminApiKey.slice(-4)
                          : "Not Set"}
                      </span>
                    </div>
                    <div className="flex justify-between">
