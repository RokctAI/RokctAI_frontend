...
export async function createAiLead(data: {
  lead_name: string;
  organization?: string;
  email_id?: string;
  mobile_no?: string;
  ...
  try {
    ...
    return {
      success: true,
      message: "Lead created successfully via AI",
...
export async function updateAiLead(data: {
  name: string;
  ...
  try {
    ...
    return {
      success: true,
      message: "Lead updated successfully via AI",
      data: response.message,
    };
  } catch (e: any) {
