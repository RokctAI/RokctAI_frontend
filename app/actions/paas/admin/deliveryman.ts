...
export async function getDeliveryStatistics() {
  ...
  try {
    return await frappe.call({
      method:
        "paas.api.admin_logistics.admin_logistics.get_delivery_statistics",
    });
  } catch (error) {
...
export async function getDeliverymanReviews(
  ...
  try {
    return await frappe.call({
      method:
        "paas.api.admin_logistics.admin_logistics.get_deliveryman_reviews",
      args: { limit_start: start, limit_page_length: limit },
    });
  } catch (error) {
...
export async function getDeliverymanRequests(
  ...
  try {
    return await frappe.call({
      method:
        "paas.api.admin_logistics.admin_logistics.get_deliveryman_requests",
      args: { limit_start: start, limit_page_length: limit },
    });
  } catch (error) {
...
export async function updateDeliverymanRequest(name: string, status: string) {
  ...
  try {
    await frappe.call({
      method:
        "paas.api.admin_logistics.admin_logistics.update_deliveryman_request",
