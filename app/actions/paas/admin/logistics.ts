...
export async function getDeliverySettings() {
  ...
  try {
    return await frappe.call({
      method:
        "paas.api.admin_logistics.admin_logistics.get_deliveryman_global_settings",
    });
  } catch (error) {
...
export async function updateDeliverySettings(settings: any) {
  ...
  try {
    await frappe.call({
      method:
        "paas.api.admin_logistics.admin_logistics.update_deliveryman_global_settings",
...
export async function getVehicleTypes(page: number = 1, limit: number = 20) {
  ...
  try {
    return await frappe.call({
      method:
        "paas.api.admin_logistics.admin_logistics.get_delivery_vehicle_types",
...
export async function createVehicleType(data: any) {
  ...
  try {
    await frappe.call({
      method:
        "paas.api.admin_logistics.admin_logistics.create_delivery_vehicle_type",
      args: { type_data: data },
    });
...
export async function deleteVehicleType(name: string) {
  ...
  try {
    await frappe.call({
      method:
        "paas.api.admin_logistics.admin_logistics.delete_delivery_vehicle_type",
      args: { type_name: name },
    });
    revalidatePath("/paas/admin/logistics/vehicles");
    return { success: true };
