...
"""Static contract tests for productivity/nextjs's gateway calls.
...
way is silently empty (productivity_sdk 1.0.1). Every server action reaches the
...
class GatewayCallTests(unittest.TestCase):
    ...
    def test_gateway_calls_present(self):
        ...
        self.assertGreaterEqual(len(self._hits(GATEWAY_CALL_RE)), 8)
