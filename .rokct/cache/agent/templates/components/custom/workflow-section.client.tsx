...
// The workflow section's CLIENT half (since 1.18.0): the persona carousel,
// unchanged. Rendered by ./workflow-section.tsx, the section's entry, which
// holds `meta` where the server can read it.
