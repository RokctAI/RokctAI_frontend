...
// browser lives in the sibling ./workflow-section.client.tsx and is rendered
// from here.
...
import { WorkflowSection } from "@/components/custom/workflow-section.client";

export { WorkflowSection } from "@/components/custom/workflow-section.client";
...
export default function WorkflowSectionEntry({ id }: PageSectionProps) {
  return <WorkflowSection id={id} />;
}
