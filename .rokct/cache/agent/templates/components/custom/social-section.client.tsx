...
// The social section's CLIENT half (since 1.18.0): the carousel and the
// framer cards, unchanged. Rendered by ./social-section.tsx, the section's
// entry, which holds `meta` where the server can read it.
