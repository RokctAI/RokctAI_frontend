...
// browser lives in the sibling ./copied-pricing.client.tsx and is rendered
// from here.

import React from "react";

import { CopiedPricing } from "@/components/custom/copied-pricing.client";
import type {
  PageSectionMeta,
  PageSectionProps,
} from "@/components/custom/landing/page-sections";

export { CopiedPricing } from "@/components/custom/copied-pricing.client";
 ...
 * page order (after the plan cards) and the floating-nav entry "Pricing"
 * scrolls to this deck, as it did in the shell.
 */
...
export default function CopiedPricingEntry({ id }: PageSectionProps) {
  return <CopiedPricing id={id} />;
}
