...
import {
  ...
  updateCoupon,
  deleteCoupon,
} from "@/app/actions/promotions/marketing";
    ...
    <div className="p-8 space-y-8">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage discount coupons for your shop.
          </p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            List of all coupons available for your customers.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
              ...
              {coupons.length === 0 ? (
                ...
                coupons.map((coupon) => (
                  <TableRow key={coupon.name}>
                    ...
                    <TableCell>
                      {coupon.expired_at
                        ? format(new Date(coupon.expired_at), "MMM d, yyyy")
                        : "No Expiry"}
                    </TableCell>
