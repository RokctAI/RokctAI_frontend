...
import { getEmailSubscribers } from "@/app/actions/promotions/admin/marketing";
import {
  Card,
  CardContent,
  CardDescription,
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>List of all email subscribers.</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
            ...
            <TableBody>
              {subscribers.map((sub) => (
                <TableRow key={sub.name}>
                  ...
                  <TableCell>
                    {new Date(sub.creation).toLocaleDateString()}
                  </TableCell>
                </TableRow>
              ))}
