...
import { getParcelOrder, updateParcelStatus } from "@/app/actions/orders/parcel";
...
export default function ParcelOrderDetailsPage({
  params,
}: {
  params: { id: string };
}) {
    ...
    async function fetchOrder() {
      try {
        ...
        if (!data) {
          ...
          router.push("/manager/orders/parcels");
          return;
        }
        setOrder(data);
      } catch (error) {
  ...
  return (
    <div className="p-8 space-y-8 max-w-4xl mx-auto">
      <div className="flex items-center gap-4">
        <Link href="/manager/orders/parcels">
          ...
          <CardHeader>
            <div className="flex justify-between items-start">
              <div>
                ...
                <CardDescription>
                  Placed on{" "}
                  {format(new Date(order.creation), "MMM d, yyyy 'at' HH:mm")}
                </CardDescription>
              </div>
              <Badge
            ...
            <div className="grid gap-4 border rounded-lg p-4 bg-muted/20">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    {typeof order.address_from === "string" &&
                    order.address_from.startsWith("{")
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    {typeof order.address_to === "string" &&
                    order.address_to.startsWith("{")
