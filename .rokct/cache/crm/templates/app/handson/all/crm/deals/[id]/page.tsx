...
export default async function DealDetails({
  ...
  const [dealRes, timelineRes] = await Promise.all([
    getDeal(params.id),
    getTimeline("Opportunity", params.id),
  ]);
    ...
    return (
      <div className="p-6">
        ...
        <Button asChild variant="link" className="pl-0 mt-4">
          <Link href="/handson/all/crm/deals">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="text-right">
          <div className="text-2xl font-bold">
            {formatCurrency(deal.annual_revenue, deal.currency)}
          </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex items-center gap-3">
                <Avatar>
                  <AvatarImage
                    src={deal.opportunity_owner_image}
                    alt={deal.opportunity_owner_name || deal.opportunity_owner}
                  />
                  <AvatarFallback>
                    {getInitials(deal.opportunity_owner_name || deal.opportunity_owner)}
                  </AvatarFallback>
                </Avatar>
                <div>
                  <p className="font-medium text-sm">
                    {deal.opportunity_owner || "Unassigned"}
                  </p>
                </div>
              </div>
            </CardContent>
