...
export function AnnouncementCard({ announcements }: { announcements: Announcement[] }) {
    ...
    return (
        <div className="bg-gradient-to-br from-amber-500/10 to-transparent border border-amber-500/30 rounded-xl p-4 w-full max-w-sm">
            ...
            <div className="space-y-4">
                {announcements.map((item) => (
                    <div key={item.name} className="relative pl-4 border-l-2 border-amber-500/30">
