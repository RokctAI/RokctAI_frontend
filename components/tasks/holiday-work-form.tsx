            ...
            <div className="flex flex-col gap-2 max-h-32 overflow-y-auto border p-2 rounded-md bg-zinc-50 dark:bg-zinc-900">
              {availableDepts.length === 0 ? (
                ...
                availableDepts.map((dept: any) => (
                  <label
                    key={dept.name}
                    className="flex items-center gap-2 text-sm cursor-pointer hover:bg-zinc-100 dark:hover:bg-zinc-800 p-1 rounded"
                  >
                    <input
                      type="checkbox"
