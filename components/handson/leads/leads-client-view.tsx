...
export function LeadsClientView({ leads }: { leads: any[] }) {
  ...
  const activeColumns = LEAD_STATUSES.filter(
    (s) =>
      kanbanItems.some((i: any) => i.status === s) ||
      ["Lead", "Open", "Converted"].includes(s),
  );
                        ...
                        <td className="p-4 align-middle">
                          <div className="flex flex-col">
                            <span className="text-sm font-medium">
                              {lead.organization || "Private Individual"}
                            </span>
                            {lead.industry && (
                        ...
                        <td className="p-4 align-middle">
                          <div className="flex items-center gap-2">
                            {lead.kyc_status === "Verified" ? (
                              ...
                              <Badge
                                variant="outline"
                                className="text-amber-600 border-amber-200 px-2 py-0 bg-amber-50/50"
                              >
                                Pending
                              </Badge>
                            )}
