...
import { createQuotation, updateQuotation, QuotationData } from "@/app/actions/handson/all/accounting/selling/quotation";
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            <div className="flex justify-between items-center">
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="text-2xl font-bold">{isEdit ? `Edit Quotation: ${initialData.name}` : "New Quotation"}</h1>
                </div>
            ...
            <Card>
                ...
                <CardContent className="grid md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                        ...
                        />
                        <p className="text-xs text-muted-foreground">Type exact Customer Name (e.g. generic-customer)</p>
                    </div>
                    <div className="space-y-2">
