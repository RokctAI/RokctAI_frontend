...
export function ProspectList({ prospects }: ProspectListProps) {
  ...
  const filtered = prospects.filter(
    (p) =>
      ...
      (p.customer_group &&
        p.customer_group.toLowerCase().includes(searchTerm.toLowerCase())),
  );
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage potential customer companies.
          </p>
        </div>
                ...
                <TableRow key={prospect.name}>
                  ...
                  <TableCell>
                    <div className="flex gap-2 justify-end">
                      <Link
                        href={`/handson/all/commercial/crm/prospects/${prospect.name}`}
                      >
