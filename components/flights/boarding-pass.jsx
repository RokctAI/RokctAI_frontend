...
exports.DisplayBoardingPass = DisplayBoardingPass;
...
function DisplayBoardingPass(_a) {
    var _b = _a.boardingPass, boardingPass = _b === void 0 ? SAMPLE : _b;
    return (<div className="bg-yellow-200 p-4 rounded-lg flex flex-col gap-2">
      <div className="flex flex-row justify-between items-center relative">
        ...
        <div className="absolute w-full flex flex-row justify-center">
          <div className="text-amber-800">
            <lucide_react_1.PlaneTakeoffIcon />
          </div>
        </div>
      ...
      <div className="flex flex-row justify-between">
        ...
        <div className="flex flex-col gap-0.5">
          ...
          <div className="text-lg text-yellow-700">
            {(0, date_fns_1.format)(new Date(boardingPass.departure.timestamp), "h:mma")}
          </div>
        </div>
      </div>
    </div>);
