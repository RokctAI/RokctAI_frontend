          ...
          <div className="flex-1 relative h-[550px] lg:h-[500px] w-full">
            ...
            <motion.div
              ...
              animate={{
                ...
                left: activeCardIndex === 1 ? "0%" : "0%",
                x: activeCardIndex === 1 ? "0%" : "-15%",
                scale: activeCardIndex === 1 ? 1 : 0.95,
                opacity: activeCardIndex === 1 ? 1 : 0.6,
                filter:
                  activeCardIndex === 1 ? "brightness(1)" : "brightness(0.7)",
            ...
            >
              ...
              <div className="absolute -left-12 top-[180px] hidden lg:flex">
                <div
                  onClick={() => setActiveCardIndex(1)}
                  className={`border border-r-0 border-zinc-200 dark:border-zinc-800 rounded-l-xl py-8 w-12 shadow-[-10px_0_15px_-3px_rgba(0,0,0,0.1)] transition-colors duration-300 flex items-center justify-center ${activeCardIndex === 1 ? "bg-white dark:bg-[#111] z-20" : "bg-zinc-100 dark:bg-zinc-800 cursor-pointer z-0"}`}
                >
                  <span
                    className={`font-bold text-sm -rotate-90 whitespace-nowrap tracking-widest ${activeCardIndex === 1 ? "text-zinc-900 dark:text-white" : "text-zinc-500"}`}
                  >
                    Others
                  </span>
                </div>
                  ...
                  <div className="flex -space-x-2">
                    <div className="h-8 w-8 rounded-full border-2 border-white dark:border-[#111] overflow-hidden bg-white">
                      <Image
                        ...
                        src="https://cdn.getmerlin.in/cms/Avatar_2_eee035b8d3.png"
                        alt="icon"
                        width={32}
                        height={32}
                    ...
                    <div className="flex items-center justify-between py-3 border-b border-zinc-100 dark:border-zinc-800/50">
                      <div className="flex items-center gap-2">
                        <Image
                          unoptimized
                          referrerPolicy="no-referrer"
                          src="https://cdn.getmerlin.in/cms/claude_7fd6ca1b3a.svg"
                          alt="Claude AI"
                          width={20}
                          height={20}
                    ...
                    <div className="flex items-center justify-between py-3 border-b border-zinc-100 dark:border-zinc-800/50">
                      <div className="flex items-center gap-2">
                        <Image
                          unoptimized
                          referrerPolicy="no-referrer"
                          src="https://cdn.getmerlin.in/cms/gemini_860192f244.svg"
                          alt="Gemini Advanced"
                          width={20}
                          height={20}
                          className="rounded-full"
                    ...
                    <div className="flex items-center justify-between py-3 border-b border-zinc-100 dark:border-zinc-800/50">
                      <div className="flex items-center gap-2">
                        <Image
                          unoptimized
                          referrerPolicy="no-referrer"
                          src="https://cdn.getmerlin.in/cms/mistral_997ea81364.svg"
                          alt="Mistral AI"
                          width={20}
                          height={20}
                          className="rounded-full"
                    ...
                    <div className="flex items-center justify-between py-3">
                      <div className="flex items-center gap-2">
                        <Image
                          unoptimized
                          referrerPolicy="no-referrer"
                          src="https://cdn.getmerlin.in/cms/meta_0e8914c0f0.svg"
                          alt="Open source model hosting"
                          width={20}
                          height={20}
                          className="rounded-full"
                        />
            ...
            <motion.div
              ...
              animate={{
                ...
                filter:
                  activeCardIndex === 1 ? "brightness(0.9)" : "brightness(0.7)",
                rotateY: activeCardIndex === 1 ? 0 : 5,
                originX: 0,
              }}
              transition={{ type: "spring", stiffness: 300, damping: 30 }}
                  ...
                  <div className="flex -space-x-2">
                    <div className="h-8 w-8 rounded-full border-2 border-zinc-200 dark:border-zinc-700 overflow-hidden bg-white">
                      <Image
                        unoptimized
                        referrerPolicy="no-referrer"
                        src="https://cdn.getmerlin.in/cms/Avatar_4_36664caa88.svg"
                        alt="icon"
                        width={32}
                        height={32}
                        className="w-full h-full object-cover"
            ...
            <motion.div
              ...
              animate={{
                ...
                left: activeCardIndex === 0 ? "0%" : "0%",
                x: activeCardIndex === 0 ? "0%" : "-15%",
                scale: activeCardIndex === 0 ? 1 : 0.95,
                opacity: activeCardIndex === 0 ? 1 : 0.6,
                filter:
                  activeCardIndex === 0 ? "brightness(1)" : "brightness(0.7)",
            ...
            >
              ...
              <div className="absolute -left-12 top-16 hidden lg:flex">
                <div
                  onClick={() => setActiveCardIndex(0)}
                  className={`border border-r-0 border-zinc-800 dark:border-zinc-200 rounded-l-xl py-8 w-12 shadow-[-10px_0_15px_-3px_rgba(0,0,0,0.3)] transition-colors duration-300 flex items-center justify-center ${activeCardIndex === 0 ? "bg-zinc-900 dark:bg-white z-20" : "bg-zinc-800 dark:bg-zinc-100 cursor-pointer z-0"}`}
                >
                  <span
                    className={`font-bold text-sm -rotate-90 whitespace-nowrap tracking-widest ${activeCardIndex === 0 ? "text-white dark:text-zinc-900" : "text-zinc-400 dark:text-zinc-600"}`}
                  >
                    AI
                  </span>
                </div>
              ...
              <div className="w-[280px] md:w-[340px] flex flex-col rounded-[2rem] bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 p-6 md:p-8 md:px-12 relative overflow-hidden shadow-2xl border border-zinc-800 dark:border-zinc-200 h-full hover:border-zinc-700 dark:hover:border-zinc-300 transition-colors duration-300 z-10">
                ...
                <div className="relative z-40 flex flex-col h-full">
                  <div className="flex items-center gap-3 mb-5">
                    <div className="h-8 w-8 rounded-full border-2 border-zinc-900 dark:border-white overflow-hidden bg-white flex items-center justify-center">
                      <Image
                        unoptimized
                        referrerPolicy="no-referrer"
                        src="https://cdn.getmerlin.in/cms/Group_2_b0e06c28f9.svg"
                        alt={`${PLATFORM_NAME} icon`}
                        width={20}
                        height={20}
                  ...
                  <div className="flex flex-col sm:flex-row gap-2.5 mb-10">
                    <Link
                      href="/pricing"
                      className="flex-1 flex items-center justify-center px-4 py-2.5 bg-white text-zinc-900 dark:bg-zinc-900 dark:text-white rounded-full font-bold text-sm hover:scale-[1.02] transition-transform duration-200"
                    >
                      Buy now
                    </Link>
                    <Link
                      href="/pricing"
                      className="flex-1 flex items-center justify-center px-4 py-2.5 bg-transparent border border-white/20 dark:border-black/20 text-white dark:text-zinc-900 rounded-full font-bold text-sm hover:bg-white/5 dark:hover:bg-black/5 transition-colors duration-200"
                    >
                      Explore plans
                    </Link>
                  </div>
