...
const TESTIMONIALS = [
  {
    ...
    text: "{{platform}} is a welcome addition to anyone looking to simplify their research and writing process. I found the tool to be very user-friendly, fast, and reliable.",
    author: "PetePlus",
    role: "AppSumo user",
  ...
  },
  {
    ...
    role: "{{platform}} Pro user",
    avatar: "https://cdn.getmerlin.in/cms/Avatar_1_6e26bd801c.svg"
  },
  {
    title: "5 STAR Product.",
    text: "The team is VERY responsive. Any new ideas or bugs get talked about. They want to make {{platform}} genuinely really good. You can just tell by how engaged they are, and how they make changes based on feedback.",
    author: "gkc",
    role: "AppSumo user",
  ...
  },
  {
    ...
    text: "As a student, {{platform}} AI has been invaluable for my academic work. The tool's automatic summarization and advanced text analysis features have significantly boosted my productivity and understanding.",
  ...
  },
  {
    ...
    text: "The reason for gaining trust in {{platform}} lies in their communication approach. They are more honest in their communication than expected, and while they can't accommodate everything, they provide satisfaction with quick responses to users' demands. I give it 10/10!!",
  ...
  },
  {
    ...
    text: "My Lil brother had an assignment for UNI, to use an AI to summarize a doc and display the key points using charts, Powerbi, etc.. Everyone used ChatGPT, Gemini, nothing fancy. Lil bro used {{platform}} per my advise. He got an A+ and doesn't need to attend the finals from this project. I guess the professor thought he's an AI genius. Thanks {{platform}} 😂🦾",
  ...
  },
  {
    ...
    text: "{{platform}}'s user-friendly interface makes research effortless. By centralizing all my sources, it eliminates the frustration of switching between apps and losing track of valuable information.",
  ...
  },
  {
    ...
    text: "One of the best looking apps I've seen so far in the AI space. Integrates directly with my browser at the top toolbar. The coolest part is the Cmd + M keyboard friendliness. I've spoken to the developers and can assure that {{platform}} will only get better with time.",
    author: "Scorphx",
    role: "Extension user",
