      ...
      try {
        ...
        if (zone.zone_path) {
          ...
          if (Array.isArray(parsed)) {
            ...
            path = parsed.features[0].geometry.coordinates[0].map((c: any) => ({
              lat: c[1],
              lng: c[0],
            }));
          }
      ...
      try {
        ...
        if (route.route_path) {
          ...
          if (Array.isArray(parsed)) {
            ...
            parsed.features &&
            parsed.features[0].geometry.type === "LineString"
          ) {
            path = parsed.features[0].geometry.coordinates.map((c: any) => ({
              lat: c[1],
              lng: c[0],
            }));
          }
