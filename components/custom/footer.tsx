      ...
      <div className="container mx-auto px-6 max-w-screen-2xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-7 gap-12 mb-24">
          ...
          <div className="flex flex-col gap-6 lg:col-span-1">
            ...
            <div className="mt-4">
               <button className="flex items-center gap-2 bg-zinc-900 px-6 py-3 rounded-xl text-gray-300 hover:text-white transition-colors border border-white/5">
          ...
          {/* Column 6: Company */}
          <div className="flex flex-col gap-6">
            <h4 className="font-bold text-gray-500 uppercase tracking-widest text-xs">Company</h4>
            <div className="flex flex-col gap-4">
              <Link href="#" className="text-base text-gray-400 hover:text-white transition-colors">Team</Link>
              <Link href={getTermLink("Privacy Policy")} className="text-base text-gray-400 hover:text-white transition-colors">Privacy Policy</Link>
              <Link href={getTermLink("Legal")} className="text-base text-gray-400 hover:text-white transition-colors">Legal</Link>
              <Link href={getTermLink("Cookie Policy")} className="text-base text-gray-400 hover:text-white transition-colors">Cookie Policy</Link>
              ...
              <Link href={getTermLink("Data Protection")} className="text-base text-gray-400 hover:text-white transition-colors">Data Protection</Link>
              <Link href="/careers" className="text-base text-gray-400 hover:text-white transition-colors">Careers</Link>
              <Link href={getTermLink("Refund Policy")} className="text-base text-gray-400 hover:text-white transition-colors">Refund Policy</Link>
              <Link href={getTermLink("Query Standards")} className="text-base text-gray-400 hover:text-white transition-colors">Query Standards</Link>
            </div>
          </div>

          {/* Column 7: Resources */}
          <div className="flex flex-col gap-6">
            <h4 className="font-bold text-gray-500 uppercase tracking-widest text-xs">Resources</h4>
            <div className="flex flex-col gap-4">
